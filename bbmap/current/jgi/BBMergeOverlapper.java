...
//			sb.append("_bb=").append(String.format(Locale.ROOT, "%.4f", bestBad*.1f));
//			sb.append("_bg=").append(String.format(Locale.ROOT, "%.4f", bestGood*.1f));
...
//			sb.append("_sbb=").append(String.format(Locale.ROOT, "%.4f", secondBestBad*.1f));
//			sb.append("_sbg=").append(String.format(Locale.ROOT, "%.4f", secondBestGood*.1f));
